...
const Achievements = (function () {
  ...
  const DEFS = [
    ...
    { id: "bouncer_master", icon: "🟪", name: "Rimbalzo perfetto", desc: "Completa un livello che contiene un trampolino." },
    { id: "zero_gravity", icon: "🎈", name: "Gravità azzerata", desc: "Completa un livello che contiene una zona a gravità leggera." },
    { id: "challenge_pack", icon: "💎", name: "Vera sfida", desc: "Completa tutti i livelli dal 20 al 27." },
  ];
