...
const LEVELS = [
  ...
  },
  {
    ...
    ground: [{ x: 0, w: 960 }],
    obstacles: [
      { x: 430, y: 505, w: 26, h: 110 },
      { x: 700, y: 500, w: 200, h: 40 },
    ],
    targets: [{ x: 700, y: 452, r: 28 }],
    par: 3,
  },
  {
    id: 5,
  ...
  {
    id: 15,
    name: "FIG. 15 — TRAMPOLINO",
    launcher: { x: 110, y: 500 },
    ground: [{ x: 0, w: 960 }],
    obstacles: [
      { type: "bouncer", x: 500, y: 548, w: 90, h: 24, restitution: 10.0 },
      { x: 650, y: 490, w: 26, h: 140 },
    ],
    targets: [{ x: 830, y: 430, r: 20 }],
    par: 2,
  },
  {
    id: 16,
    name: "FIG. 16 — GRAVITÀ LEGGERA",
    launcher: { x: 110, y: 500 },
    ground: [
      { x: 0, w: 380 },
      { x: 640, w: 320 },
    ...
    obstacles: [],
    gravityZones: [{ x: 510, y: 400, w: 280, h: 320, strength: 2.25 }],
    targets: [{ x: 880, y: 538, r: 22 }],
    par: 2,
  },
  {
    id: 17,
    name: "FIG. 17 — DOPPIO SALTO",
    launcher: { x: 110, y: 500 },
    ground: [{ x: 0, w: 960 }],
    obstacles: [
      { type: "bouncer", x: 400, y: 548, w: 80, h: 24, restitution: 9.0 },
      { type: "bouncer", x: 650, y: 548, w: 80, h: 24, restitution: 9.0 },
    ],
    targets: [{ x: 880, y: 400, r: 22 }],
    par: 4,
  },
  {
    id: 18,
    name: "FIG. 18 — FLOTTANTE",
    launcher: { x: 110, y: 500 },
    ground: [{ x: 0, w: 960 }],
    obstacles: [],
    gravityZones: [{ x: 650, y: 420, w: 260, h: 300, strength: 2.4 }],
    targets: [
      {
        x: 820,
        y: 420,
        r: 20,
        movement: { axis: "y", center: 420, amplitude: 50, speed: 0.0024 },
      },
    ],
    par: 3,
  },
  {
    ...
    obstacles: [
      { type: "bouncer", x: 200, y: 548, w: 80, h: 24, restitution: 10.0 },
      { type: "rotator", x: 700, y: 460, w: 110, h: 14, speed: 0.0011 },
    ],
    gravityZones: [{ x: 450, y: 400, w: 260, h: 320, strength: 2.1 }],
    targets: [
      {
        x: 880,
        y: 460,
  ...
  // ===== Pacchetto "vera sfida" (20-27) =====

  {
    id: 20,
    name: "FIG. 20 — PASSAGGIO STRETTO",
    launcher: { x: 110, y: 500 },
    ground: [{ x: 0, w: 960 }],
    obstacles: [
      { type: "rotator", x: 450, y: 460, w: 100, h: 14, speed: 0.0013 },
      { type: "rotator", x: 600, y: 460, w: 100, h: 14, speed: -0.0015 },
    ],
    targets: [{ x: 800, y: 538, r: 20 }],
    par: 4,
  },
  {
    id: 21,
    name: "FIG. 21 — CORRENTE INCROCIATA",
    launcher: { x: 110, y: 500 },
    ground: [
      { x: 0, w: 360 },
      { x: 640, w: 320 },
    ...
    obstacles: [],
    windZones: [
      { x: 400, y: 450, w: 120, h: 250, fx: 0, fy: -0.0015 },
      { x: 540, y: 400, w: 200, h: 280, fx: 0.002, fy: 0 },
    ],
    targets: [{ x: 820, y: 500, r: 22 }],
    par: 4,
  },
  {
    id: 22,
    name: "FIG. 22 — DOPPIO PORTALE",
    launcher: { x: 110, y: 500 },
    ground: [{ x: 0, w: 960 }],
    obstacles: [
      { x: 400, y: 480, w: 26, h: 160 },
      { x: 700, y: 480, w: 26, h: 160 },
    ],
    portals: [
      { x1: 250, y1: 538, x2: 550, y2: 460, r: 22 },
      { x1: 600, y1: 538, x2: 850, y2: 460, r: 20 },
    ],
    targets: [{ x: 880, y: 420, r: 22 }],
    par: 5,
  },
  {
    id: 23,
    name: "FIG. 23 — TRAMPOLINO DI PRECISIONE",
    launcher: { x: 110, y: 500 },
    ground: [{ x: 0, w: 960 }],
    obstacles: [
      { type: "bouncer", x: 450, y: 548, w: 70, h: 24 },
      { x: 700, y: 490, w: 20, h: 140 },
      { x: 900, y: 490, w: 20, h: 140 },
    ],
    targets: [{ x: 800, y: 500, r: 26 }],
    par: 3,
  },
  {
    id: 24,
    name: "FIG. 24 — INGRANAGGI GEMELLI",
    launcher: { x: 110, y: 500 },
    ground: [{ x: 0, w: 960 }],
    obstacles: [
      { type: "rotator", x: 500, y: 460, w: 110, h: 14, speed: 0.0013 },
      { type: "rotator", x: 680, y: 460, w: 110, h: 14, speed: -0.0016 },
    ],
    targets: [
      {
        x: 850,
        y: 460,
        r: 20,
        movement: { axis: "y", center: 460, amplitude: 45, speed: 0.0025 },
      },
    ],
    par: 5,
  },
  {
    id: 25,
    name: "FIG. 25 — VUOTO E CORRENTE",
    launcher: { x: 110, y: 500 },
    ground: [
      { x: 0, w: 360 },
      { x: 640, w: 320 },
    ],
    obstacles: [{ type: "rotator", x: 720, y: 460, w: 100, h: 14, speed: 0.0012 }],
    windZones: [{ x: 500, y: 400, w: 280, h: 320, fx: 0.0019, fy: 0 }],
    targets: [{ x: 880, y: 538, r: 22 }],
    par: 4,
  },
  {
    id: 26,
    name: "FIG. 26 — LEVITAZIONE INSTABILE",
    launcher: { x: 110, y: 500 },
    ground: [{ x: 0, w: 960 }],
    obstacles: [],
    gravityZones: [{ x: 480, y: 350, w: 280, h: 400, strength: 2.2 }],
    portals: [{ x1: 480, y1: 180, x2: 820, y2: 480, r: 24 }],
    targets: [{ x: 820, y: 440, r: 26 }],
    par: 4,
  },
  {
    id: 27,
    name: "FIG. 27 — LA PROVA FINALE",
    launcher: { x: 110, y: 500 },
    ground: [
      { x: 0, w: 320 },
      { x: 560, w: 400 },
    ...
    obstacles: [
      { type: "rotator", x: 680, y: 460, w: 110, h: 14, speed: 0.0012 },
      { type: "bouncer", x: 820, y: 548, w: 70, h: 24 },
    ],
    windZones: [{ x: 440, y: 400, w: 240, h: 300, fx: 0.0018, fy: 0 }],
    portals: [{ x1: 250, y1: 538, x2: 600, y2: 480, r: 22 }],
    targets: [
      {
        x: 900,
        y: 400,
        r: 22,
        movement: { axis: "y", center: 400, amplitude: 40, speed: 0.0027 },
      },
    ],
    par: 6,
  },
...
// Portali/zone-vento/zone-gravità sono opzionali: garantiamo che esistano
// sempre come array cosi il resto del codice non deve controllare ogni volta
// se sono definiti.
