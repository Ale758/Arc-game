...
const LEVELS = [
  ...
  },
  {
    ...
    ground: [{ x: 0, w: 960 }],
    obstacles: [
      { type: "bouncer", x: 500, y: 548, w: 90, h: 24, restitution: 5.0 },
  ...
  },
  {
    ...
    obstacles: [],
    gravityZones: [{ x: 510, y: 400, w: 280, h: 320, strength: 0.75 }],
  ...
  },
  {
    ...
    ground: [{ x: 0, w: 960 }],
    obstacles: [
      { type: "bouncer", x: 400, y: 548, w: 80, h: 24, restitution: 4.5 },
      { type: "bouncer", x: 650, y: 548, w: 80, h: 24, restitution: 4.5 },
    ],
  ...
  },
  {
    ...
    ground: [{ x: 0, w: 960 }],
    obstacles: [],
    gravityZones: [{ x: 650, y: 420, w: 260, h: 300, strength: 0.8 }],
    targets: [
      {
        x: 820,
        y: 420,
  ...
  },
  {
    ...
    obstacles: [
      { type: "bouncer", x: 200, y: 548, w: 80, h: 24, restitution: 5.0 },
      { type: "rotator", x: 700, y: 460, w: 110, h: 14, speed: 0.0011 },
    ],
    gravityZones: [{ x: 450, y: 400, w: 260, h: 320, strength: 0.7 }],
    targets: [
      {
        x: 880,
        y: 460,
